...
Serverless architecture with AWS Lambda, Azure Functions, Cloud Functions

## When to Use This Framework

Serverless architecture with AWS Lambda or Azure Functions or Cloud Functions is appropriate when you need:
