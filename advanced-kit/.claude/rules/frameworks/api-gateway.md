# api gateway Framework Rules

API gateway patterns for Kong, Tyk, AWS API Gateway

## When to Use This Framework

API gateway patterns for Kong or Tyk or AWS API Gateway is appropriate when you need:
