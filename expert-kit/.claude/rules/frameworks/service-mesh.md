# service mesh Framework Rules

Service mesh configuration for Istio, Linkerd, Consul

## When to Use This Framework

Service mesh configuration for Istio or Linkerd or Consul is appropriate when you need:
