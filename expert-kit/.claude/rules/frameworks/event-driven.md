# event driven Framework Rules

Event-driven architecture with Kafka, RabbitMQ, event sourcing, CQRS

## When to Use This Framework

Event-driven architecture with Kafka or RabbitMQ or event sourcing or CQRS is appropriate when you need:
